...
恒参信道，又称为<span style="border-bottom: 1.5px dashed orange;">加性高斯白噪</span>声信道模型
...
1. 系统幅频响应常数
2. 系统相频响应线性
3. <span style="border-bottom: 1.5px dashed orange;">群迟延特性常数</span>（不同频谱分量都为等时延迟）
...
乘性噪声随时间随机快变，引发<span style="border-bottom: 1.5px dashed orange;">多径效应</span>

多径传播产生瑞利型衰落、引起<span style="border-bottom: 1.5px dashed orange;">频率弥散</span>
...
幅值满足<span style="border-bottom: 1.5px dashed orange;">瑞利分布</span>、相位满足<span style="border-bottom: 1.5px dashed orange;">均匀分布</span>
