...
1. $E_X\{E[Y/X]\}=E[Y]$,即<span style="border-bottom: 1.5px dashed orange;">条件期望的期望为无条件期望</span>
...
当<span style="border-bottom: 1.5px dashed orange;">互不相关</span>时，有$E[X Y]=E[X]E[Y]$
...
<span style="border-bottom: 1.5px dashed orange;">斜率</span>即为线性相关系数
