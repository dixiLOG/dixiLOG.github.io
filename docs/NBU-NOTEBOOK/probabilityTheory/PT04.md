...
关于 随机变量 X 的<span style="border-bottom: 1.5px dashed orange;">指数复函数</span>为其【特征函数】，即
...
!!! note "题外话—指数积分通用表达式"
    ...
    ??? quote "推导过程"
        ...
        对于<span style="border-bottom: 1.5px dashed orange;">标准高斯变换</span>，有
...
> 为一对<span style="border-bottom: 1.5px dashed orange;">伪</span>傅里叶变换对  
> 特征函数 ≈ 时域 | 概率密度函数 ≈ 频域
